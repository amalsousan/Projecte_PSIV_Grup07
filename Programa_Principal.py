"""
Projecte PSIV: Què em poso avui? - Creant el nostre armari
Autors: Berta Masdeu i Feixas, Mar Matarín Romero, Laura Terrón Martínez, Amal Sousan Chikh
Descripció: Sistema de gestió d'armari intel·ligent amb visió per computador (Otsu, K-Means) 
i deep learning (YOLO) basat en anàlisi colorimètric a l'espai HSL.
"""
import math
import cv2
import numpy as np
